...
#
# Script generated by Vivado on Mon Apr 13 16:51:22 +0200 2026
...
#
# Usage        : Uvod2.sh
#                Uvod2.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                Uvod2.sh [-reset_run]
#                Uvod2.sh [-reset_log]
#                Uvod2.sh [-help]
#
...
# script info
echo -e "Uvod2.sh - Script generated by export_simulation (Vivado v2025.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./Uvod2.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot Uvod2 xil_defaultlib.Uvod2 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim Uvod2 -key {Behavioral:sim_1:Functional:Uvod2} -tclbatch cmd.tcl -protoinst "protoinst_files/Uvod2.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb Uvod2.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./Uvod2.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: Uvod2.sh [-help]\n\
Usage: Uvod2.sh [-step]\n\
Usage: Uvod2.sh [-lib_map_path]\n\
Usage: Uvod2.sh [-reset_run]\n\
Usage: Uvod2.sh [-reset_log]\n\
Usage: Uvod2.sh [-keep_index]\n\
Usage: Uvod2.sh [-noclean_files]\n\n\
