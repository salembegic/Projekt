...
HD_PWD='C:/Users/Salem/Desktop/Uvod2/Uvod2/Uvod2.runs/Uvod2_clk_wiz_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Uvod2_clk_wiz_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Uvod2_clk_wiz_0_0.tcl
