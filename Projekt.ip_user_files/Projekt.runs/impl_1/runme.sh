...
HD_PWD='C:/Users/vaje/Desktop/Salem/SalemPEV/2.5/PEV/Projekt/Projekt.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Uvod2_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Uvod2_wrapper.tcl -notrace
