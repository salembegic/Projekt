...
HD_PWD='C:/Users/vaje/Desktop/Salem/SalemPEV/2.5/PEV/Projekt/Projekt.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Uvod2_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Uvod2_wrapper.tcl
